...
> 拾学 v0.2.3 已发布 Windows 安装包、Portable EXE、updater 元数据和带 updater 签名的更新载荷；这些 Windows 二进制尚未做 Authenticode。代码签名身份、SmartScreen 信誉和端到端升级验证仍是独立工作；每个派生应用都必须配置并保护自己的更新端点和签名私钥。
